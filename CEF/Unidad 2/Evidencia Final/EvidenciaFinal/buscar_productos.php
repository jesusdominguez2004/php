...
<div class="container">
  <div class="row"> <!-- row = fila -->
    ...
    <center><h3> Buscar productos Almacen <img src="img/buscar.png" width="50"><img src="img/caja.jpg" width="50"></h3></center>
        ...
        <form method="POST" action="mostrar_busqueda_productos.php">
        ...
        <!-- Botón submit que llevará al action (mostrar_busqueda_productos.php) -->
        <button type="submit" class="btn btn-success">Buscar producto</button>
        <!-- Hipervínculo con clase botón que llevará al menú 'menú.php' -->
