...
<html>
<head>
    <title> Resultados eliminar usuarios | Almacen</title>
    <meta charset="utf-8">
...
<!-- Resultado "Guardar Usuario" -->
        ...
        # Incluir las dos otras hojas PHP (El módulo de clase, y la hoja de consultas)
            ...
            $dato_entrada->setID_Cliente($id_cliente);

            $proceso = new clase_ingreso();
            $consulta = $proceso->Consulta_eliminar_cliente($dato_entrada);
        ?>
...
<div class="container">
  <div class="row"> <!-- row = fila -->
    ...
    <div class="col-sm-6"><br><br><br>
        <?php
            echo "<center>Se ha borrado el cliente (ID Cliente = ".$id_cliente.")"."</center><br>";
