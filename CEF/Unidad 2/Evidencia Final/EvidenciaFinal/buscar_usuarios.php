...
<html>
<head>
    <title>Buscar usuarios | Almacen</title>
    <meta charset="utf-8">
...
<div class="container">
  <div class="row"> <!-- row = fila -->
    ...
    <!-- Formulario centrado -->
    <center><h3> Buscar usuarios Almacen <img src="img/buscar.png" width="45"><img src='img/usuario 1.png' height='35'></h3></center>
        
        <form method="POST" action="mostrar_busqueda_usuarios.php">

        <!-- Primer input "Nombre" Tipo "number" -->
        <div class="form-group"> 
          <label for="ejemplo_text_1">ID Usuario</label>
          <input type="number" placeholder="Ingrese id usuario a buscar" name="id_usuario" class="form-control">
        </div>
