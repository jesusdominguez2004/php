...
<div class="container">
  <div class="row"> <!-- row = fila -->
    ...
    <!-- <center><h3> Buscar productos Almacen <img src="img/buscar.png" width="50"><img src="img/caja.jpg" width="50"></h3></center>-->
        ...
        <div class="row"> 
          <?php
             echo "<div class='container'><a>¿Desea eliminar este cliente? </strong></a><input name='id_cliente' readonly value='$id_cliente'></div>";
          ?>
        </div><br>
        ...
        <a href="buscar_clientes_eliminar.html" class="btn btn-dark">No, no deseo eliminarlo</a>
        </form>
