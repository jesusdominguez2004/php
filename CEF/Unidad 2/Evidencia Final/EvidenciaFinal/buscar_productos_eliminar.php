...
<html>
<head>
    <title>Buscar productos | Almacen</title>
    <meta charset="utf-8">
...
<div class="container">
  <div class="row"> <!-- row = fila -->
    ...
    <center><h3> Buscar productos Almacen <img src="img/buscar.png" width="50"><img src="img/caja.jpg" width="50"></h3></center>
        ...
        <form method="POST" action="mostrar_busqueda_productos_eliminar.php">

        <!-- Primer input "Nombre" Tipo "number" -->
        <div class="form-group"> 
          <label for="ejemplo_text_1">Código producto</label>
          <input type="number" placeholder="Ingrese código producto a buscar" name="codigo_prod" class="form-control">
        </div>
